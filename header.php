...
<script src="https://kit.fontawesome.com/75610805ea.js" crossorigin="anonymous"></script>
  ...
  <a class="navbar-brand" href="index.php"><i class="fa-solid fa-cubes"></i>Ma bibliothèque<i class="fa-solid fa-microchip"></i></a>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-sharp fa-solid fa-user-secret"></i> Gestion des auteurs</a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
